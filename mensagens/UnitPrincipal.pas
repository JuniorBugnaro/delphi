...
begin
  Application.MessageBox('Teste de Mensagem', 'Informação', MB_ICONINFORMATION);
end;
...
begin
  Application.MessageBox('Teste de Mensagem', 'Titulo', MB_ICONQUESTION);
end;
...
begin
  ...
  begin
    ShowMessage('Você escolheu opção NÃO');
  end;
